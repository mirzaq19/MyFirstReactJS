      ...
      <div className="d-flex flex-wrap justify-content-center position-absolute w-100 h-100 align-items-center align-content-center">
        ...
        <div className="btn-group">
          ...
          <div className="dropdown-menu">
            ...
            <a className="dropdown-item" href="#" onClick={e => this.changeTheme('Primary', e)}>Primary Theme</a>
            <a className="dropdown-item" href="#" onClick={e => this.changeTheme('Danger', e)}>Danger Theme</a> 
            <a class="dropdown-item" href="#" onClick={e => this.changeTheme('Success', e)}>Success Theme</a>
